...
def main():
    ...
    pm = PerceptronModel(DATA_FILE, features_to_use)
...
def select_features_to_use():
    ...
    features_to_use.append(constants.CHARGE_DESC_NO_CHARGE)
    features_to_use.append(constants.CHARGE_DESC_LICENSE_ISSUE)
    features_to_use.append(constants.CHARGE_DESC_PUBLIC_DISTURBANCE)
    ...
    features_to_use.append(constants.CHARGE_DESC_WEAPONS_RELATED)
    features_to_use.append(constants.CHARGE_DESC_EVADING_ARREST)
    features_to_use.append(constants.CHARGE_DESC_NONVIOLENT_HARM)
    features_to_use.append(constants.CHARGE_DESC_THEFT_FRAUD_BURGLARY)
